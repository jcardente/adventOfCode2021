...
# most common bit, the least common bit from each position is
...
if __name__ == '__main__':
    ...
    if args.part == 'part1':
        ...
        ans = gamma * epsilon
        print(f'Part 1: Gamma={gamma} Epsilon={epsilon} Ans={ans}')
        ...
        ans = ogr * csr
        print(f'Part 2: OGR={ogr} CSR={csr} Ans={ans}')
